         ...
         <div class="card">
            <div class="card-block">
               <div class="ex-page-content text-center">
                  <h1 class="mb-0">Errore</h1>
                  <h5 class="">Login errata</h5>
                  <br><a class="btn btn-danger mb-5 waves-effect waves-light text-light" href="index.php">Torna alla home page</a>
               </div>
            </div>
         </div>
      </div>
